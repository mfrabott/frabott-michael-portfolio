  ...
  return (
    <div className='footer'>
      <section className="contact-info" id="contact-info">
          ...
          <a href="https://www.github.com/mfrabott"><img src={ghLogo} className="contact-link contact-link-img"></img></a>
          <a href="https://www.linkedin.com/in/michael-frabott"><img src={liLogo} className="contact-link contact-link-img"></img></a>
